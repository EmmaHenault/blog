...
public class ArticleCreateDTO {
    ...
    public @NotEmpty(message = "La liste des images ne doit pas être vide") List<@Valid ImageDTO> getImages() {
        return images;
    }

    public void setImages(@NotEmpty(message = "La liste des images ne doit pas être vide") List<@Valid ImageDTO> images) {
        this.images = images;
    }

    public @NotEmpty(message = "La liste des auteurs ne doit pas être vide") List<@Valid AuthorContributionDTO> getAuthors() {
        return authors;
    }

    public void setAuthors(@NotEmpty(message = "La liste des auteurs ne doit pas être vide") List<@Valid AuthorContributionDTO> authors) {
